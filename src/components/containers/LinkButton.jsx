...
export default function LinkButton({ text, variant }) {
  return (
      <button
          className={`${variant == "light" ? "bg-white text-black":"bg-black text-white"} font-inter py-2 px-5 rounded-full transition-colors duration-300 text-base font-semibold whitespace-nowrap md:text-base`}
      >
