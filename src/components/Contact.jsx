        ...
        <section className="mt-32  text-white bg-black md:rounded-[64px]">
            <div className=" md:text-left md:py-28  lg:w-[94%] w-full max-w-auto mx-auto">
                <div className="md:px-6  text-center md:text-left md:w-full p-6  sm:p-0">
                    ...
                    <div className='  mx-auto w-[50%] my-8'>
                        <div className={`font-inter mr-6 w-full py-16 px-16 bg-[#1C1C1C]`}>
                            <div className='flex flex-row mb-9 '>
                                <input type="name" name="" id="" placeholder='Name' className='bg-[#1C1C1C] w-full mr-3 border-0 border-b-2 border-b-white placeholder:text-white placeholder:text-base font-inter font-medium focus:outline-none' />
                                
                                <input type="email" name="" id="" placeholder='Email' className='bg-[#1C1C1C] w-full border-0 border-b-2 border-b-white placeholder:text-white placeholder:text-base font-inter font-medium focus:outline-none' />
                            </div>
                            <input type="text" name="" id="" placeholder='Description' className='bg-[#1C1C1C] h-[158px] w-full border-0 border-b-2 border-b-white placeholder:text-white placeholder:text-base font-inter font-medium focus:outline-none pt-3' />
                            <button
                                className={` bg-white text-black w-full mt-6 font-inter py-2 px-5 rounded-full transition-colors duration-300 text-base font-semibold whitespace-nowrap md:text-base`}
                            >
                                Subscribe
                            </button>
