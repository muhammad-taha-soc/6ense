...
export default function Contact() {
    return (
        <section id='contact' className="mt-32  text-white bg-black md:rounded-[64px]">
            <div className=" md:text-left md:py-28  lg:w-[94%] w-full max-w-auto mx-auto">
                <div className="md:px-6  text-center md:text-left md:w-full p-6">
                    ...
                    <div className='mx-auto w-[80%] my-16 px-4  '>
                        <div className={`font-inter w-full py-16 px-4   bg-[#1C1C1C]`}>
